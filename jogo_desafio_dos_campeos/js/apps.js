...
function selecionarCampeao(nome) {
  ...
  window.location.href = "/jogo_desafio_dos_campeos/indexhistory.html"; // Redirecionar para a página da história
}
...
function criarPersonagem() {
  window.location.href = "/jogo_desafio_dos_campeos/indexMP.html"; // Página de criação de personagem
}
...
function carregarCampeao() {
  ...
  document.querySelector(".champion-img").src = campeao.imagem || "/jogo_desafio_dos_campeos/assets/default-character.svg";
...
function iniciarBatalha(criatura, proximaHistoria) {
  ...
  window.location.href = "/jogo_desafio_dos_campeos/indexBatalha.html";  // Redirecionar para a batalha
}
...
function comecarAventura() {
  ...
  window.location.href = "/jogo_desafio_dos_campeos/indexhistory.html"; // Redirecionar para a página de história
}
...
if (!campeao || !criatura) {
  ...
  window.location.href = "/jogo_desafio_dos_campeos/indexhistory.html"; // Redirecionar de volta à história se houver erro
}
...
function fugir() {
  ...
  window.location.href = `/jogo_desafio_dos_campeos/indexhistory.html?id=${historiaDeOrigem}`;
}
...
function verificarMorte() {
  if (campeao.energia <= 0) {
    ...
    window.location.href = "/jogo_desafio_dos_campeos/gameover.html";
  } else if (criatura.energia <= 0) {
    alert("Você venceu a criatura!");
    salvarEstadoBatalha();
    const proximaHistoria = localStorage.getItem("proximaHistoria");
    if (proximaHistoria) {
      window.location.href = `/jogo_desafio_dos_campeos/indexhistory.html?id=${proximaHistoria}`;
    } else {
      alert("Erro: Próxima história não encontrada.");
      window.location.href = '/jogo_desafio_dos_campeos/indexhistory.html';
    }
  }
}
